...
- This delivery tier deals with caching and delivering front-end assets to the client. E.g:
  - **Content Delivery Networks(CDN):** They have multiple servers all across the world and help deliver a web applications HTML, CSS, JavaScript code and images to a client from the nearest physically located server.
